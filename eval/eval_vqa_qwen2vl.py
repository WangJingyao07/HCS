...
from models.qwen2_vl.qwen2vl_wrapper import Qwen2VLWrapper
...
def main():
    ...
    qwen = Qwen2VLWrapper(model_path=model_path, dtype="bfloat16")
    ans = qwen.generate(masked_img_pil, q, max_new_tokens=max_new_tokens, temperature=temperature)
    print("[Question]", q)
    print("[Answer]", ans)
